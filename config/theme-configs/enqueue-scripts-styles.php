...
function block_editor_scripts() {
	wp_enqueue_script("block_editor_scripts", get_stylesheet_directory_uri(). "/dist/admin.js", array(), null, true); //TODO: get these to output right so can serve from child theme
