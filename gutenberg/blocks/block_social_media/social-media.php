...
function render_socialmedia_block($attributes) {
	...
	if($attributes['facebook'] == 'true' && $facebook) {
		$facebookLink = '<mark class="social-icon margin-right-2x"><a href="'.$facebook.'" target="_blank" aria-label="Facebook profile link"><i class="fab fa-facebook-f"></i></a></mark>';
	}

	if($attributes['twitter'] == 'true' && $twitter) {
		$twitterLink = '<mark class="social-icon margin-right-2x"><a href="https://twitter.com/'.$twitter.'" target="_blank" aria-label="Twitter profile link"><i class="fab fa-twitter"></i></a></mark>';
	}

	if($attributes['instagram'] == 'true' && $instagram) {
		$instagramLink = '<mark class="social-icon margin-right-2x"><a href="https://www.instagram.com/'.$instagram.'" target="_blank" aria-label="Instagram profile link"><i class="fab fa-instagram"></i></a></mark>';
	}

	if($attributes['pinterest'] == 'true' && $pinterest) {
		$pinterestLink = '<mark class="social-icon margin-right-2x"><a href="https://www.pinterest.com/'.$pinterest.'" target="_blank" aria-label="Pinterest profile link"><i class="fab fa-pinterest-p"></i></a></mark>';
	}
	if($attributes['linkedin'] == 'true' && $linkedin) {
		$linkedinLink = '<mark class="social-icon margin-right-2x"><a href="'.$linkedin.'" target="_blank" aria-label="Linkedin profile link"><i class="fab fa-linkedin-in"></i></a></mark>';
	}

	if($attributes['medium'] == 'true' && $medium) {
		$mediumLink = '<mark class="social-icon margin-right-2x"><a href="'.$medium.'" target="_blank" aria-label="Medium profile link"><i class="fab fa-medium-m"></i></a></mark>';
	}

	if($attributes['youtube'] == 'true' && $youtube) {
		$youtubeLink = '<mark class="social-icon margin-right-2x"><a href="'.$youtube.'" target="_blank" aria-label="Youtube profile link"><i class="fab fa-youtube"></i></a></mark>';
	}

	if($attributes['github'] == 'true' && $github) {
		$githubLink = '<mark class="social-icon margin-right-2x"><a href="'.$github.'" target="_blank" aria-label="Github profile link"><i class="fab fa-github"></i></a></mark>';
	}
