 ...
 */
export default registerBlockType( 'flexlayout/socialmedia', {
	title: __( 'Social Media', 'flexlayout' ),
	description: __(
		'Display links to your social media accounts. Accounts are set in Global Settings ',
		'flexlayout'
	),
	category: 'common',
	icon: icons.social,
	...
	keywords: [ __( 'Social media', 'flexlayout' ) ],
	attributes: {
		facebook: {
			type: 'boolean',
			default: false,
