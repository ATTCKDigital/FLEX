...
if ( ! FLEX.isProd ) {
	console.log(
		'loaded',
		'/FLEX\t/gutenberg\t/blocks\t/block_carousel\t/carousel.js'
	);
}
...
// Register block
export default registerBlockType( 'flexlayout/carousel', {
	...
	keywords: [ __( 'carousel', 'flexlayout' ), __( 'slide', 'flexlayout' ) ],
	attributes: {
		automate: {
			type: 'boolean',
			default: true,
	...
	styles: [
		{
			name: 'carousel-bleed',
			label: __( 'Bleed (default)', 'block style' ),
			isDefault: true,
		},
