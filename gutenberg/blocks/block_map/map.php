<?php
namespace FLEX_LAYOUT_SYSTEM\Blocks\Map;
...
function register_map_block() {
	...
	register_block_type( 'flexlayout/map', [
		...
		'render_callback' => __NAMESPACE__ . '\render_map_block',
	] );
}
...
function render_map_block($attributes) {
	...
	$output = "<div class=\"component-map component {$class}\" {$CSSWidth} data-component-name=\"{$dataComponentName}\" {$dataComponentOptions} data-googlemapsapikey=\"\">";
