		...
		$el.on(
			...
			function ( e ) {
				...
				if (
					...
					console.log(
						'/FLEX/\tgutenberg/\tblocks/\tblock_video/\tplay-video.js',
						'onPlayerReady(), .playVideo keypress › exiting, pressed the  ' +
							e.key +
							', key: ' +
							keyCode
					);
				...
				console.log(
					'/FLEX/\tgutenberg/\tblocks/\tblock_video/\tplay-video.js',
					'onPlayerReady(), adding playingVideo class'
				);
				$el.addClass( 'playingVideo' );
		...
		$el.on(
			...
			function ( e ) {
				...
				if (
					...
					console.log(
						'/FLEX/\tgutenberg/\tblocks/\tblock_video/\tplay-video.js',
						'onPlayerReady(), .pauseVideo keypress › exiting, pressed the  ' +
							e.key +
							', key: ' +
							keyCode
					);
				...
				console.log(
					'/FLEX/\tgutenberg/\tblocks/\tblock_video/\tplay-video.js',
					'onPlayerReady(), removing playingVideo class'
				);
				$el.removeClass( 'playingVideo' );
