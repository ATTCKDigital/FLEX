...
function column_options_classes( $attributes ) {
	...
	$class .= array_key_exists('columnPhonePlus', $attributes) && $attributes['columnPhonePlus'] != 'inherit' ? " flex-phone-plus-{$attributes['columnPhonePlus']}-{$attributes['columnCount']}" : '';
