...
function margin_options_classes( $attributes ) {
	...
	$class .= array_key_exists('marginXlTop', $attributes) && $attributes['marginXlTop'] != 'inherit' ? " margin-xl-top-{$attributes['marginXlTop']} " :'';
	$class .= array_key_exists('marginXlRight', $attributes) && $attributes['marginXlRight'] != 'inherit' ? " margin-xl-right-{$attributes['marginXlRight']} " :'';
	$class .= array_key_exists('marginXlLeft', $attributes) && $attributes['marginXlLeft'] != 'inherit' ? " margin-xl-left-{$attributes['marginXlLeft']} " :'';
	$class .= array_key_exists('marginXlBottom', $attributes) && $attributes['marginXlBottom'] != 'inherit' ? " margin-xl-bottom-{$attributes['marginXlBottom']} " :'';
	
	$class .= array_key_exists('marginXl2Top', $attributes) && $attributes['marginXl2Top'] != 'inherit' ? " margin-xl2-top-{$attributes['marginXl2Top']} " :'';
	$class .= array_key_exists('marginXl2Right', $attributes) && $attributes['marginXl2Right'] != 'inherit' ? " margin-xl2-right-{$attributes['marginXl2Right']} " :'';
	$class .= array_key_exists('marginXl2Left', $attributes) && $attributes['marginXl2Left'] != 'inherit' ? " margin-xl2-left-{$attributes['marginXl2Left']} " :'';
	$class .= array_key_exists('marginXl2Bottom', $attributes) && $attributes['marginXl2Bottom'] != 'inherit' ? " margin-xl2-bottom-{$attributes['marginXl2Bottom']} " :'';
