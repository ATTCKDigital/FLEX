...
3. Go to https://api.wordpress.org/secret-key/1.1/salt/ and get new Authentication Unique Keys and Salts. Paste this snippet into `lines 67-74` of `wp-config.php` in the WordPress root
