...
function Timer( $el, options ) {
	...
	if (
		...
		typeof _options.hour !== 'undefined'
	) {
	...
	function identifyActiveDigits() {
		...
		$( '.component-timer' )
			.find( '.timer-hours .digit' )
			.removeClass( 'active' );
		$( '.component-timer' )
			.find( '.timer-minutes .digit' )
			.removeClass( 'active' );
		$( '.component-timer' )
			.find( '.timer-seconds .digit' )
			.removeClass( 'active' );

		$( '.component-timer' )
			.find(
				'.timer-hours .first-digit .digit-' + _remainingHourFirstDigit
			)
			.addClass( 'active' );
		$( '.component-timer' )
			.find(
				'.timer-hours .second-digit .digit-' + _remainingHourSecondDigit
			)
			.addClass( 'active' );
		$( '.component-timer' )
			.find(
				'.timer-minutes .first-digit .digit-' +
					_remainingMinuteFirstDigit
			)
			.addClass( 'active' );
		$( '.component-timer' )
			.find(
				'.timer-minutes .second-digit .digit-' +
					_remainingMinuteSecondDigit
			)
			.addClass( 'active' );
		$( '.component-timer' )
			.find(
				'.timer-seconds .first-digit .digit-' +
					_remainingSecondFirstDigit
			)
			.addClass( 'active' );
		$( '.component-timer' )
			.find(
				'.timer-seconds .second-digit .digit-' +
	...
	function insertTimerMarkup() {
		...
		markup.push(
			'<ul><li class="timer-digits-container timer-days"><span class="first-digit">'
		);
		...
		markup.push( '<span class="digit digit-9 ">9</span>' );
		markup.push(
			'</span><span class="timer-digit-label position-bottom">DAYS</span></li></ul>'
		);

		markup.push(
			'<ul><li class="timer-digits-container timer-hours"><span class="first-digit">'
		);
		markup.push( '<span class="digit digit-0 active">0</span>' );
		markup.push( '<span class="digit digit-1 ">1</span>' );
		markup.push( '<span class="digit digit-2 ">2</span>' );
		...
		markup.push( '<span class="digit digit-9 ">9</span>' );
		markup.push(
			'</span><span class="timer-digit-label position-bottom">HRS</span></li></ul>'
		);

		markup.push(
			'<ul><li class="timer-digits-container timer-minutes"><span class="first-digit">'
		);
		...
		markup.push(
			'</span><span class="timer-digit-label position-bottom">MIN</span></li></ul>'
		);

		markup.push(
			'<ul><li class="timer-digits-container timer-seconds"><span class="first-digit">'
		);
		markup.push( '<span class="digit digit-0">0</span>' );
		markup.push( '<span class="digit digit-1">1</span>' );
		markup.push( '<span class="digit digit-2">2</span>' );
		...
		markup.push( '<span class="digit digit-9 active">9</span>' );
		markup.push(
			'</span><span class="timer-digit-label position-bottom">SEC</span></li></ul>'
		);
	...
	function startTimerAnimation() {
		...
		function animateTimer( timestamp ) {
			...
			if ( elapsed > 1000 ) {
				...
				if (
					parseInt( _remainingSecondSecondDigit, 10 ) === 0 &&
					parseInt( _remainingSecondFirstDigit, 10 ) === 0 &&
					parseInt( _remainingMinuteSecondDigit, 10 ) === 0 &&
					parseInt( _remainingMinuteFirstDigit, 10 ) === 0
				) {
					//$('body').removeClass('showTimer');
				}

				$( '.component-timer' )
					.find( '.timer-days .digit' )
					.removeClass( 'active' );
				$( '.component-timer' )
					.find( '.timer-hours .digit' )
					.removeClass( 'active' );
				...
				$( '.component-timer' )
					.find(
						'.timer-days .second-digit .digit-' +
							_remainingDaySecondDigit
					)
					.addClass( 'active' );
				$( '.component-timer' )
					.find(
						'.timer-hours .first-digit .digit-' +
							_remainingHourFirstDigit
					)
					.addClass( 'active' );
				$( '.component-timer' )
					.find(
						'.timer-hours .second-digit .digit-' +
							_remainingHourSecondDigit
					)
					.addClass( 'active' );
				$( '.component-timer' )
	...
	function timerDiscountApplies() {
		...
		if (
			parseInt( _remainingMinuteFirstDigit, 10 ) === 0 &&
			parseInt( _remainingMinuteSecondDigit, 10 ) < 2
		) {
			applies = false;
		}
