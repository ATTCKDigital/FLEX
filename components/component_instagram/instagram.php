...
<div class="component-instagram">
	<h4 class="<?= $this->displayTitleClass;?> align-center margin-small-bottom-2x"><a href="<?= $instagram;?>" target="_blank"><i class="fab fa-instagram"></i><?php _e( 'Instagram', '_flexlayout' );?></a></h4>
