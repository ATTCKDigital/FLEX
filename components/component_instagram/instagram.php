...
<div class="component-instagram">
	...
	<span class="display-block caption2 align-center uppercase margin-bottom-0x color-text-black"><a href="<?= $instagram;?>" target="_blank">@<?= get_field('instagram_username', 'options');?></a></span>
