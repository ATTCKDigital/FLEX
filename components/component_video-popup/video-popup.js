...
function VideoPopup($el, params={}) {
	console.log('/FLEX/\tcomponents/\tcomponent_video-popup/\tvideo-popup.js', 'VideoPopup()');
	...
	function bindEvents() {
		console.log('/FLEX/\tcomponents/\tcomponent_video-popup/\tvideo-popup.js', 'bindEvents()');
		...
		$watchButton.on('click keypress', function (e) {
			...
			if (e.type === 'keypress' && typeof keyCode !== 'undefined' && keyCode !== 13) {
				console.log('/FLEX/\tcomponents/\tcomponent_video-popup/\tvideo-popup.js', '$watchButton keypress › exiting, pressed the  ' + e.key + ', keyCode: ' +  keyCode);
				return;
			} else {
				console.log('/FLEX/\tcomponents/\tcomponent_video-popup/\tvideo-popup.js', '$watchButton keypress › pressed ' + e.key + ' key:type ' + e.type + ', keyCode: ' + keyCode);
			}
		...
		$closeButton.on('click keypress', function (e) {
			...
			// 27 = esc
			if (e.type === 'keypress' && typeof keyCode !== 'undefined' && keyCode !== 13) {
				console.log('/FLEX/\tcomponents/\tcomponent_video-popup/\tvideo-popup.js', '$closeButton keypress › exiting, pressed the  ' + e.key + ', keyCode: ' + keyCode);
				return;
			} else {
				console.log('/FLEX/\tcomponents/\tcomponent_video-popup/\tvideo-popup.js', '$closeButton keypress › pressed ' + e.key + ' key:type ' + e.type + ', keyCode: ' + keyCode);
			}
	...
	function displayPopup(e) {
		console.log('/FLEX/\tcomponents/\tcomponent_video-popup/\tvideo-popup.js', 'displayPopup()');
	...
	function hidePopup() {
		console.log('/FLEX/\tcomponents/\tcomponent_video-popup/\tvideo-popup.js', 'hidePopup()');
	...
	function addVideoSrc($srcElement) {
		console.log('/FLEX/\tcomponents/\tcomponent_video-popup/\tvideo-popup.js', 'addVideoSrc($srcElement:) ', $srcElement);
	...
	function render() {
		console.log('/FLEX/\tcomponents/\tcomponent_video-popup/\tvideo-popup.js', 'render()');
	...
	this.init = function ($el) {
		console.log('/FLEX/\tcomponents/\tcomponent_video-popup/\tvideo-popup.js', 'e()');
